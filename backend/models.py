...
class Book(Base):
    ...
    copies = Column(Integer, default=1)  # number of copies available total
    # Note: copies represents current available copies
...
class Borrow(Base):
    ...
    return_date = Column(DateTime, nullable=True)  # null until returned
